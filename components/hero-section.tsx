...
const LINKS = {
  chatbot:
    "https://academic-rag-chatbot-wbtrq9pwrqdwdilwvheywf.streamlit.app/",
}
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mb-10 text-pretty">
            An AI-powered academic assistant that retrieves answers directly from
            lecture PDFs and PowerPoint slides using Retrieval-Augmented
            Generation (RAG).
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Button
              size="lg"
              variant="outline"
              className="gap-2 px-8 py-6 text-base font-medium bg-transparent"
              onClick={() =>
                document
                  .getElementById("demo")
